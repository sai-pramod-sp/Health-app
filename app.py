...
@app.route('/diaresult',methods = ["POST"])
def result():
    if request.method == 'POST':
        to_predict_list = request.form.to_dict()
        to_predict_list=list(to_predict_list.values())
...
def predictdiabetes():
    if request.method == "POST":
        ...
        if len(to_predict_list) == 8:
            result = ValuePredictor(to_predict_list, 8)
    if(int(result) == 1):
        prediction = "Sorry ! Suffering... Patient has a high risk of diabetes Disease, please consult your doctor immediately"
    else:
        prediction = "Congrats ! you are Healthy. You have low risk of dibetes Disease"
...
def predictdiaheart():
    if request.method == "POST":
        ...
        if len(to_predict_list) == 11:
            result = ValuePredictor(to_predict_list, 11)
    if(int(result) == 1):
        prediction = " Sorry ! Suffering... Patient has a high risk of heart Disease, please consult your doctor immediately"
    else:
        prediction ="Congrats ! you are Healthy. You have low risk of Heart Disease.."
    return render_template("heart_result.html", prediction=prediction)


@app.route("/predictkidney",  methods=['GET', 'POST'])
def predictdictkidney():
    if request.method == "POST":
        to_predict_list = request.form.to_dict()
        to_predict_list = list(to_predict_list.values())
        to_predict_list = list(map(float, to_predict_list))
        if len(to_predict_list) == 12:
            result = ValuePredictor(to_predict_list, 12)
    if(int(result) == 1):
        prediction = "Sorry ! Suffering... Patient has a high risk of kidney Disease, please consult your doctor immediately"
    else:
        prediction = "Congrats ! you are Healthy. You have low risk of kidney Disease"
    return render_template("kidney_result.html", prediction=prediction)
...
def predictliver():
    if request.method == "POST":
        ...
        if len(to_predict_list) == 10:
            result = ValuePredictor(to_predict_list, 10)
    if(int(result) == 1):
        prediction = "Sorry ! Suffering... Patient has a high risk of liver Disease, please consult your doctor immediately"
    else:
        prediction = "Congrats ! you are Healthy. You have low risk of Liver Disease.."
...
def predictcancer():
    if request.method == "POST":
        ...
        if len(to_predict_list) == 30:
            result = ValuePredictor(to_predict_list, 30)
    if(int(result) == 1):
        prediction = "Sorry ! Suffering... Patient has a high risk of cancer Disease, please consult your doctor immediately"
    else:
        prediction ="Congrats ! you are Healthy. You have low risk of cancer Disease.."
    return render_template("cancer_result.html", prediction=prediction)
